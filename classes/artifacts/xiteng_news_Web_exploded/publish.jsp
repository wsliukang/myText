     ...
     <!--使用panel定义面板 panel-primary规定面板的皮肤颜色(也可以设为panel-info等)-->
         <div  class="panel panel-primary">
            ...
            <div class="panel-body">
               <form action="NewsManageServlet?type=add" name="formen" method="post">
               <!--form-group对每个表单域进行分组-->
                  ...
                  <div class="form-group">
                      <label>简介:</label>
                      <!--给表单域添加form-control样式，能够美化文本框-->
                      <input type="textarea" class="form-control" name="brief" placeholder="必填" required>
                  </div>
                   <div class="form-group">
                      <label>作者</label>
                      <!--给表单域添加form-control样式，能够美化文本框-->
                      <input type="text" class="form-control" name="author" placeholder="必填" required>
                  </div>
              	 <div class="form-group">
                      <label>内容:</label>
...
<button type="button"  class="glyphicon glyphicon-picture " aria-hidden="true" onclick="document.formen.addPicutre.click()"></button> 
                      ...
                      <!--给表单域添加form-control样式，能够美化文本框-->
                  	  <textarea class="form-control" id="content" rows="4" name="content" placeholder="必填" required></textarea>
                  </div>
